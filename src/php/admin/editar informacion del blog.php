                    ...
                    <div class="mt-8">
                        ...
                        <script>
                            ...
                            function handleFileSelect(event) {
                              ...
                              <div class="mt-6">
                                <button
                                    class="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-green-500 rounded-md hover:bg-green-300 focus:outline-none focus:bg-blue-400 focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                                  Cambiar
                                </button>
                                <div class="flex justify-between mb-2">
