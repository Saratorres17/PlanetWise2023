    ...
    <div class="flex">
        ...
        <div class="scroll bg-white-200 bg-opacity-70">
            <main class="py-12 md:px-20 sm:px-14 px-6">
                <div class="scroll sm:flex items-center shadow-2xl">
                    <div class="md:px-10 sm:px-5">
                        <h1 class="text-gray-400 font-bold text-2xl my-2">long established</h1>
                        <p class="text-gray-500 mb-2 md:mb-6">It is a long established fact that a reader will be
                        ...
                        <div class="flex justify-evenly">
                            <a href=""><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.0" id="Layer_1" width="30px" height="60px" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xml:space="preserve">
                                    <g>
                                ...
                                <a href="/src/php/admin/editar informacion del blog.php"><svg xmlns="http://www.w3.org/2000/svg" width="30px" height="60px" viewBox="0 0 1010 1010">
                                ...
                                <a href="/src/php/admin/Confirmación de Eliminación de publicacion.php"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="50px" height="60px" viewBox="0 0 76 76" version="1.1" baseProfile="full" enable-background="new 0 0 76.00 76.00" xml:space="preserve">
                ...
                <div class="scroll mt-6 md:flex space-x-6">
                    <div>
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 mb-2">It is a long established fact that a reader will be distracted
                                by the readable content of a page when looking at its layout. The point of using Lorem
                                Ipsum is that....</p>
                            <div class="flex justify-between mt-4">
                                <span class="font-thin text-gray-400 text-sm">May 20th 2020</span><br>
                            </div>
                        </div>
                        <div class="flex justify-evenly">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.0" id="Layer_1" width="30px" height="60px" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xml:space="preserve">
                                    <g>
                                        <path fill="#231F20" d="M24.008,32.038L9.541,27.904c-0.527-0.146-1.084,0.155-1.236,0.688c-0.151,0.53,0.156,1.084,0.688,1.236   l14.467,4.134C23.551,33.987,23.643,34,23.734,34c0.435,0,0.835-0.286,0.961-0.726C24.847,32.744,24.539,32.19,24.008,32.038z" />
                                        <path fill="#231F20" d="M24.008,39.038L9.541,34.905c-0.527-0.146-1.084,0.155-1.236,0.688c-0.151,0.531,0.156,1.084,0.688,1.236   l14.467,4.133C23.551,40.987,23.643,41,23.734,41c0.435,0,0.835-0.286,0.961-0.726C24.847,39.743,24.539,39.19,24.008,39.038z" />
                                        <path fill="#231F20" d="M24.008,25.038L9.541,20.904c-0.527-0.146-1.084,0.155-1.236,0.688c-0.151,0.53,0.156,1.084,0.688,1.236   l14.467,4.134C23.551,26.987,23.643,27,23.734,27c0.435,0,0.835-0.286,0.961-0.726C24.847,25.744,24.539,25.19,24.008,25.038z" />
                                ...
                                <a href="/src/php/admin/editar informacion del blog.php"></a><svg xmlns="http://www.w3.org/2000/svg" width="30px" height="60px" viewBox="0 0 1010 1010">
                                    <path fill="#000000" d="M832 512a32 32 0 1 1 64 0v352a32 32 0 0 1-32 32H160a32 32 0 0 1-32-32V160a32 32 0 0 1 32-32h352a32 32 0 0 1 0 64H192v640h640V512z" />
                                    <path fill="#000000" d="m469.952 554.24 52.8-7.552L847.104 222.4a32 32 0 1 0-45.248-45.248L477.44 501.44l-7.552 52.8zm422.4-422.4a96 96 0 0 1 0 135.808l-331.84 331.84a32 32 0 0 1-18.112 9.088L436.8 623.68a32 32 0 0 1-36.224-36.224l15.104-105.6a32 32 0 0 1 9.024-18.112l331.904-331.84a96 96 0 0 1 135.744 0z" />
                                </svg></a><br>
                    ...
                    <div>
                        <img src="https://img.freepik.com/foto-gratis/mano-concepto-bombilla-vidrio_23-2147826118.jpg?w=360&t=st=1691705080~exp=1691705680~hmac=4c7c02d2005bb764d5bd0f8950f3cff4015a8c0d1c155e92aaa978dfeed5fb1e" alt="">
                        <div>
                            <h1 class="mt-3 text-gray-400 text-2xl font-bold my-2">long established</h1>
                            <p class="text-gray-500 mb-2">It is a long established fact that a reader will be distracted
                                by the readable content of a page when looking at its layout. The point of using Lorem
