      ...
      <div class="container mx-auto flex flex-wrap py-6">
          ...
          <aside class="w-full md:w-1/3 flex flex-col items-center px-3">
              ...
              <div class="bg-white bg-opacity-10 text-gray-500 lg:shadow-2xl w-full flex flex-col my-4 p-6 scroll">
                  ...
                  <p class="pb-2">El Ministerio de Medio Ambiente es la entidad principal que vela por el bienestar del medio ambiente en El Salvadar. Conózcalo un poco más.</p>
