    ...
    <div class="lg:grid lg:grid-cols-2">
      <div class="py-24 px-10 lg:px-0 max-w-3xl lg:max-w-md mx-auto">
        ...
        <div class=" inline-block shadow mt-5">
          <a href="../src/php/functions/registro de infotrmacion-blog.php" class="inline-block py-3 px-4 bg-white hover:bg-indigo-100 text-indigo-500 font-medium border border-transparent rounded-md">Regístra
            tu información</a>
        </div>
      </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-32 ">
      <?php foreach ($publicaciones as $publicacion_item) : ?>
        <div class="w-96 ml-32 ">
          <div class="w-fit">
            <img class="text-center rounded-lg hover:scale-110 ease-in duration-300" src="<?php echo "http://localhost/src/php/functions/" . $publicacion_item['foto_path']; ?>" alt="">
          </div>
          <div>
            <?php
            ...
            <div class="flex items-center">
              <button class="middle none center mr-2 rounded-lg hover:bg-green bg-green-500 py-3 px-10 font-sans text-xs font-bold uppercase text-white shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" data-ripple-light="true">Leer más</button> </a>

              <a href="/pruebahome/REPOpub.php?id=<?php echo $publicacion_item['id'] ?>" id="openModalBtn" class="flex items-center justify-center w-12 h-12 bg-green-500 hover:bg-green-700 rounded-full">
