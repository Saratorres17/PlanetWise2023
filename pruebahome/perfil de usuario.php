...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['acceptReport'])) {
  $reportId = $_POST['report_id'];

  $updateQuery = "UPDATE `notificaciones` SET `accept` = 1 WHERE `id` = :reportId";
  $stmtUpdate = $pdo->prepare($updateQuery);
  $stmtUpdate->bindParam(':reportId', $reportId, PDO::PARAM_INT);
  $stmtUpdate->execute();
      ...
      <section class="relative py-16">
        <div class="container mx-auto px-4">
          ...
          <div class="relative flex min-w-0 break-words bg-white bg-opacity-10 text-gray-500 w-full mb-6 shadow-xl rounded-2xl flex-col -mt-64 justify-start p-6">
            <div class="px-6"><br>
              <div class="flex justify-center bg-black bg-opacity-10 rounded-2xl">
                <div class="lg:order-2 flex justify-center items-center">
                  <img src="<?php echo "http://localhost/src/php/functions/" . $_SESSION['photo_path']; ?>" class="shadow-xl rounded-full align-middle border-none justify-center lg:-ml-16 w-52 h-36 hidden md:flex">
                </div>
                ...
                <div id="myModal" class="fixed z-50 inset-0 flex justify-center items-center bg-black bg-opacity-70">
                  <div class="bg-white p-8 rounded shadow-lg">
                    <span class="absolute top-2 right-2 cursor-pointer" id="closeModal">&times;</span>
                    <p class="text-lg font-semibold">¡Notificaciones!</p> <br>
                    <?php foreach ($reporte as $notificacions) : ?>
                      <?php if ($notificacions['accept'] == 0) : ?>
                        <li class="text-xl"><?php echo $notificacions['reporte'] ?></li>
                ...
                <div class="w-full lg:w-4/12 px-4 lg:order-1">
                  <div class="flex justify-center py-4 lg:pt-4 pt-8">
                    ...
                    <div class="top-4 text-center relative right-44 md:right-10">
              ...
              <div class="text-center mt-12">
                ...
                <div class="mb-2 text-blueGray-600 mt-10">
                  <i class="fas fa-briefcase mr-2 text-lg text-blueGray-400"></i><?php echo $_SESSION['gender'] ?>

                </div>
                <div class="mb-2 text-blueGray-600">
                  <i class="fas fa-university mr-2 text-lg text-blueGray-400"></i><?php echo $_SESSION['correo'] ?>
                </div>
              </div>
